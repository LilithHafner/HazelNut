      ...
      if (switcher > 23 || switcher < 0) {
        switch (switcher) {
                ...
                if (match$7 !== 97) {
                  if (match$7 !== 116) {
                    ...
                    if (match$8 && match$8[0] === 111) {
                      ...
                      if (match$9 && match$9[0] === 114) {
                        ...
                        var match$11 = parse_adt(match$10[1]);
                  ...
                  if (match$13 && match$13[0] === 115) {
                    ...
                    if (match$14 && match$14[0] === 101) {
                      ...
                      var match$17 = parse_environment(match$16[1]);
                      return /* tuple */[
                              /* Rcase */Block.__(12, [
                                  match$15[0],
                                  match$16[0],
                ...
                if (match$21 !== 108) {
                  if (match$21 === 115) {
                    ...
                    if (match$22 && match$22[0] === 116) {
                      var match$23 = parse_res(match$22[1]);
                      return /* tuple */[
                              /* Rfst */Block.__(8, [match$23[0]]),
                              match$23[1]
                            ];
                    }
                  ...
                  if (match$24 && match$24[0] === 111) {
                    var match$25 = match$24[1];
                    if (match$25 && match$25[0] === 97) {
                      var match$26 = match$25[1];
                      if (match$26 && match$26[0] === 116) {
                        var match$27 = parse_float(match$26[1]);
                        return /* tuple */[
                                /* Rfloat */Block.__(1, [match$27[0]]),
                                match$27[1]
                              ];
                      }
          ...
          case 95 :
              ...
              var match$29 = parse_environment(match$28[1]);
              return /* tuple */[
                      /* Rhole */Block.__(6, [
                          match$28[0],
                          match$29[0]
          ...
          case 96 :
              ...
              if (x$2 && x$2[0] === 99) {
                var match$30 = x$2[1];
                if (match$30 && match$30[0] === 116) {
                  var match$31 = match$30[1];
                  if (match$31 && match$31[0] === 111) {
                    var match$32 = match$31[1];
                    if (match$32 && match$32[0] === 114) {
                      var match$33 = parse_int(match$32[1]);
                      var match$34 = parse_adt(match$33[1]);
                      var match$35 = parse_res(match$34[1]);
                      return /* tuple */[
                              /* Rictor */Block.__(11, [
                                  match$33[0],
                                  match$34[0],
              ...
              if (exit$1 === 2) {
                var match$36 = parse_int(x$2);
                return /* tuple */[
                        /* Rint */Block.__(0, [match$36[0]]),
                        match$36[1]
                      ];
              }
              break;
          ...
          case 103 :
              ...
              var match$38 = parse_res(match$37[1]);
              return /* tuple */[
                      /* Rpair */Block.__(7, [
                          match$37[0],
                          match$38[0]
          ...
          case 106 :
              var match$39 = parse_res(x[1]);
              return /* tuple */[
                      /* Rsnd */Block.__(9, [match$39[0]]),
                      match$39[1]
                    ];
          case 33 :
          case 34 :
...
function parse_branches(_x) {
  while(true) {
    ...
    var match$1 = parse_int(x);
    var match$2 = parse_int(match$1[1]);
    var match$3 = parse_exp(match$2[1]);
