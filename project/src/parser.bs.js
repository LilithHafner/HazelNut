...
function parse_exp(_x) {
  while(true) {
    ...
    if (x) {
      ...
      if (switcher > 23 || switcher < 0) {
        switch (switcher) {
          ...
          case 89 :
              var match$2 = parse_bool(x[1]);
              return /* tuple */[
                      /* Bool */Block.__(2, [match$2[0]]),
                      match$2[1]
                    ];
          case 90 :
              var match$3 = parse_exp(x[1]);
              var match$4 = parse_exp(match$3[1]);
              return /* tuple */[
                      /* Cons */Block.__(3, [
                          match$3[0],
                          match$4[0]
          ...
          case 93 :
              ...
              if (x$1 && x$1[0] === 115) {
                var match$5 = x$1[1];
                if (match$5 && match$5[0] === 116) {
                  var match$6 = parse_exp(match$5[1]);
                  return /* tuple */[
                          /* Fst */Block.__(9, [match$6[0]]),
                          match$6[1]
                        ];
                }
                exit = 2;
              ...
              if (exit === 2) {
                var match$7 = parse_float(x$1);
                return /* tuple */[
                        /* Float */Block.__(1, [match$7[0]]),
                        match$7[1]
                      ];
              }
              break;
          case 95 :
              var match$8 = parse_int(x[1]);
              return /* tuple */[
                      /* Hole */Block.__(6, [match$8[0]]),
                      match$8[1]
                    ];
          case 96 :
              var match$9 = parse_int(x[1]);
              return /* tuple */[
                      /* Int */Block.__(0, [match$9[0]]),
                      match$9[1]
                    ];
          case 101 :
              return /* tuple */[
          ...
          case 103 :
              var match$10 = parse_exp(x[1]);
              var match$11 = parse_exp(match$10[1]);
              return /* tuple */[
                      /* Pair */Block.__(8, [
                          match$10[0],
                          match$11[0]
    ...
    return Pervasives.failwith("Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an exp, I got \"" + (implode(x) + "\" which doesn't match any of the expected tags: ['fst', 'i', 'f', 'b', 'c', 'n', 'f', 'a', 'h', 'u', 'v', 'p', 's']"));
  };
}
...
function parse_res(_x) {
  while(true) {
      ...
      if (switcher > 23 || switcher < 0) {
        switch (switcher) {
          ...
          case 93 :
              ...
              if (x$1 && x$1[0] === 115) {
                ...
                if (match$9 && match$9[0] === 116) {
                  var match$10 = parse_res(match$9[1]);
                  return /* tuple */[
                          /* Rfst */Block.__(8, [match$10[0]]),
                          match$10[1]
                        ];
                }
                exit = 2;
              ...
              if (exit === 2) {
                var match$11 = parse_float(x$1);
                return /* tuple */[
                        /* Rfloat */Block.__(1, [match$11[0]]),
                        match$11[1]
                      ];
              }
              break;
          case 95 :
              ...
              var match$13 = parse_environment(match$12[1]);
              return /* tuple */[
                      /* Rhole */Block.__(6, [
                          match$12[0],
                          match$13[0]
          ...
          case 96 :
              var match$14 = parse_int(x[1]);
              return /* tuple */[
                      /* Rint */Block.__(0, [match$14[0]]),
                      match$14[1]
                    ];
          case 101 :
              return /* tuple */[
    ...
    return Pervasives.failwith("Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an res, I got \"" + (implode(x) + "\" which doesn't match any of the expected tags: ['fst', 'i', 'f', 'b', 'c', 'n', 'f', 'a', 'h', 'u', 'p', 's']"));
  };
}
